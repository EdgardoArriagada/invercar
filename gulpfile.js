...
// Prepare for production JavaScript
gulp.task('js:prepareForProduction', function() {
  return gulp.src([
    './js/*.js',
    '!./js/*.min.js'
  ])
    .pipe(replace('var isProduction = false', 'var isProduction = true'))
    .pipe(uglify())
    .pipe(rename({
      suffix: '.min'
    }))
...
// JS
gulp.task('js', ['js:prepareForProduction'])
...
gulp.task('index', function() {
  return gulp.src('index.html')
    ...
    .pipe(replace('dist/', ''))
    .pipe(replace('src="js/main.js', 'src="static/js/main.min.js'))
    .pipe(gulp.dest('dist'))
})
